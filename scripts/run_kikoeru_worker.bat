...
:: kikoeru服务器url
set KIKOERU_URL=http://localhost:8000

:: kikoeru服务器用户名
set KIKOERU_USER=admin

:: kikoeru服务器密码
set KIKOERU_PASSWORD=Ayoadmin
...
d:/Documents/Develop/kikoeru-translate-win-x64-v0.6.8/kikoeru-translate-server/.conda/python.exe ../run_kikoeru_worker.py
@pause